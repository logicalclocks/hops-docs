...
If a user forgets his/her password and security quesion, an administrator can reset it by going to the edit user page as shown above and selecting reset user password button.
...
The new autogenerated password will be shown. Make sure to copy it efore closing the dialog box.
