...
You can follow the Vagrant instructions above for Linux to install for OSX. Note that MySQL Cluster is not recommended for production installation on OSX, although it is OK, for developmenet setups.
