...
where <project> is the project name. Users can use this YAML file to import back their Python environment by using
the Hopsworks UI `Import` option or just skim through and use this file as a backup of their project's
previous Python environment.
